...
namespace ExamPreparation.Common.Filters
{
    public class AnswerChoiceFilter : IFilter
    {
        ...
        public AnswerChoiceFilter(string sortOrder, int pageNumber, int pageSize)
        {
            try
            {
        ...
        public AnswerChoiceFilter(string sortOrder, string sortDirection, int pageNumber, int pageSize)
        {
            try
            {
