...
{
    public class QuestionFilter : IFilter
    {
        ...
        public QuestionFilter(string sortOrder, int pageNumber, int pageSize)
        {
            try
            {
        ...
        public QuestionFilter(string sortOrder, string sortDirection, int pageNumber, int pageSize)
        {
            try
            {
